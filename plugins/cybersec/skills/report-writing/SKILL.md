...
Run the `triage-validation` skill's 7-Question Gate before writing the report. If a
prior validation pass already wrote `submission-notes.md`, append/update it instead
